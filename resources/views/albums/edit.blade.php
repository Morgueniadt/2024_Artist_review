                    ...
                    <form action="{{ route('albums.update', $album) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title', $album->title) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                            </div>
                            ...
                            <div>
                                ...
                                @if ($album->image)
                                    ...
                                    <p class="text-gray-500 text-sm mt-1">Current Image</p> <!-- Indicate current image -->
                                @endif
                            </div>
